...
def send_telegram_message():
    ...
    hook.send_message({"text": "смска от Airflow"})


with open(
    os.path.join(
        "/mnt/c/Users/My End_1ess C/Documents/Диплом/MyGithub/end1ess1/chat_bot_project/Airflow/Config",
        f"chat_bot_dag_params.yaml",
    ),
    "r",
) as ff:
